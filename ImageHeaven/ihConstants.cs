...
namespace ImageHeaven
{
    ...
    public class ihConstants
    {
        ...
        public static string PATIENTIDENTIFICATION_KEY = "PATIENTIDENTIFICATION";
        public static string COMPLAINS_KEY = "COMPLAINS";
        public static string ADMISSIONSHEET_KEY = "ADMISSIONSHEET";
        public static string PHYSICIANORDERSHEET_KEY = "PHYSICIANORDERSHEET";
        public static string ADMISSIONASSESSMENT_KEY = "ADMISSIONASSESSMENT";
        public static string FAMILYHISTORY_KEY = "FAMILYHISTORY";
        public static string CONSENTFORTREATMENT_KEY = "CONSENTFORTREATMENT";
        public static string PHYSICALEXAMINATION_KEY = "PHYSICALEXAMINATION";
        public static string MEDICALHISTORY_KEY = "MEDICALHISTORY";
        public static string TENTATIVEHISTORY_KEY = "TENTATIVEHISTORY";
        public static string MEDICALDIAGNOSIS_KEY = "MEDICALDIAGNOSIS";
        public static string CAREGIVEN_KEY = "CAREGIVEN";
        public static string TRAETMENTGIVEN_KEY = "TRAETMENTGIVEN";
        public static string THERATPEUTICORDER_KEY = "THERATPEUTICORDER";
        public static string PROGRESSNOTES_KEY = "PROGRESSNOTES";
        public static string OPERATIVEPROCEDURE_KEY = "OPERATIVEPROCEDURE";
        public static string DISCHARGEREPORT_KEY = "DISCHARGEREPORT";
        public static string DEATHREPORT_KEY = "DEATHREPORT";
        ...
        public static string MAINPETITIONANNEXTURES_FILE = "Main_petition_annextures";
        public static string AFFIDAVITSWITHANNEXTURES_FILE = "Affidavits_with_annextures";
        public static string WRITTENSTATEMENTOBJECTION_FILE = "Written_statement_objection";
        public static string CONNECTEDAPPLICATIONS_FILE = "Connected_applications";
        public static string ANALOGOUSANDCONNECTEDCASE_FILE = "Analogous_and_connected_case";
        public static string VAKALATNAMAANDWARRENT_FILE = "Vakalatname_and_warrent";
        public static string SUMMONS_FILE = "Summons";
        ...
        public static string NOTICEOFARGUMENT_FILE = "Notice_of_argument";
        ...
        public static string ORDERSAPPLICATIONS_FILE = "Orders_conn_applications";
        ...
        public static string IMPUGNEDORDER_FILE = "Impugned_order";
        public static string PAPERBOOK_FILE = "Paper_book";
        public static string PATIENTIDENTIFICATION_FILE = "Patient_identification";
        public static string COMPLAINS_FILE = "Complaints";
        public static string ADMISSIONSHEET_FILE = "Admission_sheet";
        public static string PHYSICIANORDERSHEET_FILE = "Physician_order_sheet";
        public static string ADMISSIONASSESSMENT_FILE = "Admission_assessment";
        public static string FAMILYHISTORY_FILE = "Family_history";
        public static string CONSENTFORTREATMENT_FILE = "Consent_for_treatment";
        public static string PHYSICALEXAMINATION_FILE = "Physical_examination";
        public static string MEDICALHISTORY_FILE = "Medical_history";
        public static string TENTATIVEHISTORY_FILE = "Tentative_history";
        public static string MEDICALDIAGNOSIS_FILE = "Medical_diagnosis";
        public static string CAREGIVEN_FILE = "Care_given";
        public static string TRAETMENTGIVEN_FILE = "Treatment_given";
        public static string THERATPEUTICORDER_FILE = "Theraputic_order";
        public static string PROGRESSNOTES_FILE = "Progress_notes";
        public static string OPERATIVEPROCEDURE_FILE = "Operative_procedure";
        public static string DISCHARGEREPORT_FILE = "Discharge_report";
        public static string DEATHREPORT_FILE = "Death_report";
